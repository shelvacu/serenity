...
impl Attachment {
    ...
    ///                     let _ = message.channel_id.say(&context, "Error downloading attachment");
    ///
    ///                     return;
    ///                 },
    ///             };
    ...
    ///                     let _ = message.channel_id.say(&context, "Error creating file");
    ///
    ///                     return;
    ///                 },
    ///             };
    ...
    ///             }
    ///
    ///             let _ = message.channel_id.say(&context, &format!("Saved {:?}", attachment.filename));
    ///         }
    ///     }
    ///
